...
> Si `β` quedó levemente distinto de 0 o algún quintil muestra CV alto, usa el **tuner**.
...
> Puedes escoger la mejor combinación y **volver a aplicar** `apply_mass_cut()` con esos parámetros.
...
> ¡Listo! Con esto tienes un pipeline completo, reproducible y diagnosticable
> para redes egocéntricas **comparables** entre contextos heterogéneos en densidad.
```